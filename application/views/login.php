    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-5">
                ...
                <?php endif; ?>
                <label style="margin-bottom: 10px">Are you an artist? <a href="<?php echo base_url()?>index.php/home/artistlogin" style="color: orange;padding-left: 10px">Login here</a></label>
                <br>
                <h3 class="heading" style="border-bottom:5px solid orangered;margin-bottom: 20px">User Login</h3>
